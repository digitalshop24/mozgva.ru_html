	...
	<div class="container">
		<div class="wrap">
			<div class="date">
				...
				<span>Вход: 500 <i class="fa fa-rub"></i> <span class="cash">(только наличные) Время: 20:00, 17:00 <!-- 4-6 января, 7-9 января --></span></span>
				<div class="place">
			...
			<div class="stat">
				...
				<div class="town" style="margin-top: 90px;">
					Выбор города: <a href="" class="my_town"> Москва</a>
					<div class="menu_town">
						<p><a href="http://mozgva.ru/nn">Н. Новгород</a></p>
		...
		<div class="container_16 mozgva">
			...
			<div class="grid_14 text-center info">
				<!-- <button class="btn_reit">Рейтинг команд</button> -->
				<a class="btn_reit" href="/rating" style="display: inline-block;">Рейтинг команд</a>
				<!-- <a class="btn_reit" href="championship.html" style="display: inline-block;">Чемпионат</a> -->
...
<script>
function func(tel1,tel2,ch1,ch2) {
	console.log(tel1, tel2, ch1, ch2);
...
<div id="reg" class="jqmWindow text-center">
	...
	<form action="https://docs.google.com/forms/d/1w1NNRlYgISNEHOyYYv2yV5gYLcfrZMFLbogtTzzaLXA/formResponse" method="post" class="text-center" id="form1" 
	onsubmit='func(document.getElementById("tel1").value, document.getElementById("tel2").value, document.getElementById("group_620528370_3").checked, document.getElementById("group_620528370_4").checked)'>
		<fieldset>
			...
			<p style="color: #df2929;">Дорогие друзья! Пожалуйста, будьте внимательны:<br /></p>
...
<!-- <ul class="ss-choices" role="radiogroup" aria-label="Дата  ">
	<li class="ss-choice-item"><label><span class="ss-choice-item-control goog-inline-block"><input name="entry.620528370" value="23.06.2016" id="group_620528370_1" role="radio" class="ss-q-radio" aria-label="23.06.2016" required="" aria-required="true" type="radio"></span>
...
<!-- <p>Игра №1</p> 
<ul class="ss-choices" role="radiogroup" aria-label="Дата  ">
	<li class="ss-choice-item"><label><span class="ss-choice-item-control goog-inline-block"><input name="entry.620528370" value="08.07.2016" id="group_620528370_2" role="radio" class="ss-q-radio" aria-label="08.07.2016" required="" aria-required="true" type="radio"></span>
	<span class="ss-choice-label">08.07.2016</span>
	</label></li>
</ul> -->
<p>Игра №1</p> 
<ul class="ss-choices" role="radiogroup" aria-label="Дата  ">
	<li class="ss-choice-item"><label><span class="ss-choice-item-control goog-inline-block"><input name="entry.620528370" value="12.07.2016" id="group_620528370_3" role="radio" class="ss-q-radio" aria-label="12.07.2016" required="" aria-required="true" type="radio"></span>
	<span class="ss-choice-label">12.07.2016</span>
	</label></li>
</ul>
<br><br>
<p>Игра №2</p> 
<ul class="ss-choices" role="radiogroup" aria-label="Дата  ">
	<li class="ss-choice-item"><label><span class="ss-choice-item-control goog-inline-block"><input name="entry.620528370" value="14.07.2016" id="group_620528370_4" role="radio" class="ss-q-radio" aria-label="14.07.2016" required="" aria-required="true" type="radio"></span>
	<span class="ss-choice-label">14.07.2016</span>
	</label></li>	
</ul>
...
<!-- <p id="date2">Регистрация на 24, 26, 27, 28-е ноября закрыта</p> -->
			...
			<input type="submit" value="Готово" onclick="ga('send', 'event', 'moscow', 'sent_form'); console.log('ГОТОВО');" id="mozgva_moskva" /><br>
