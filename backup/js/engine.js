...
var thank = '<div class="thank text-center"><p>Вы успешно прошли регистрацию на «Мозгву», </br>а это уже серьезный шаг к победе! <br/>Скоро вы получите SMS с подтверждением. <p>По волнующим вас вопросам звоните сюда: +7 (495) 644-52-72</p><img src="https://www.google-analytics.com/collect?v=1&tid=UA-66660086-1&cid=CLIENT_ID_NUMBER&t=event&ec=moscow&ea=form&el=send"> <!-- Мы позвоним тебе, дружочек, за час до <br> начала бар-олимпиады и убедимся, что <br>ты идешь. Лады? Ну вот и славно :)</p><p>Если что, звони +7 (987) 654-32-10 --></p> </div>';
